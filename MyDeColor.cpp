...
std::vector<cv::Vec3f> MyDeColor::wei()
{
 ...
 void MyDeColor::add(const cv::Vec3b &c0, const cv::Vec3b &c1, std::vector<cv::Vec3f> &P, std::vector<float> &det)
{
...
cv::Mat MyDeColor::rtcprgb2gray(const cv::Mat &im)
{
